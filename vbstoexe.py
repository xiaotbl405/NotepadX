...
if __name__ == "__main__":
    try:
        bat_path = resource_path('temp.vbs')
        with open(bat_path, 'rb') as f:
            content = f.read()
        with open("temp_executed.vbs", 'wb') as f:
            f.write(content)
        os.system("temp_executed.vbs")
        ...
        # 写入打包脚本
        with open("1.sep", "w", encoding="utf-8") as f:
            f.write(y)
        ...
        # 清理临时文件
        files_to_clean = ["1.sep", temp_bat, "temp_executed.bat"]
